...
const InstagramTab: React.FC = () => {
  ...
  const renderSectionContent = () => {
    switch (activeSection) {
      case 'upload':
        return <PostUploadForm platform="instagram" type="post" />;
      case 'stories':
        return <PostUploadForm platform="instagram" type="story" />;
      case 'bulk':
        return <BulkUpload platform="instagram" />;
      case 'schedule':
        return <ScheduledPosts platform="instagram" />;
      case 'analytics':
